...
score_value_5.sprite_index = spr_0;
...
if(score >= 10000) {
	...
	score_value_5.sprite_index = sc_get_number_spr(string_char_at(string(score), 5));	
} else if(score >= 1000) {
	...
	score_value_5.sprite_index = sc_get_number_spr(string_char_at(string(score), 4));	
} else if(score >= 100) {
	...
	score_value_5.sprite_index = sc_get_number_spr(string_char_at(string(score), 3));	
} else if(score >= 10) {
	score_value_4.sprite_index = sc_get_number_spr(string_char_at(string(score), 1));
	score_value_5.sprite_index = sc_get_number_spr(string_char_at(string(score), 2));	
} else if(score >= 1) {
	score_value_5.sprite_index = sc_get_number_spr(string_char_at(string(score), 1));		
}